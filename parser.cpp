...
ParseResult<Dataset> parse_dataset(const std::filesystem::path& sequence_root) {
    ...
    TRY(cam0_calibration, parse_camera_yaml(cam0_root / "sensor.yaml"));
    TRY(cam1_calibration, parse_camera_yaml(cam1_root / "sensor.yaml"));
    TRY(imu_calibration, parse_imu_yaml(imu0_root / "sensor.yaml"));
    TRY(stereo_pairs, parse_stereo_pairs_csv(
                          cam0_root / "data.csv",
                          cam0_root / "data",
                          cam1_root / "data.csv",
                          cam1_root / "data"));
    TRY(imu_measurements, parse_imu_measurements_csv(imu0_root / "data.csv"));
    TRY(ground_truth_states, parse_ground_truth_csv(ground_truth_root / "data.csv"));
